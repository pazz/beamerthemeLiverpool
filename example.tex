...
% TITLE DEMO 3
{
\setbeamercolor{normal text}{fg=White,bg=Sky Blue}
\setbeamercolor{institute}{fg=Black}
\setbeamercolor{author}{fg=Black}
\setbeamercolor{date}{fg=Pink}
\setbeamerfont{author}{series=\bf,size=\huge}
\setbeamertemplate{background}[image right][extra/uol-vg-bw.png]
\maketitle
}
...
\begin{frame}[uolcolours=Dark Green] % use white on green colouring
\maketitle
\end{frame}
}
