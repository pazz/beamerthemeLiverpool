...
%\usetheme{Liverpool}
\usecolortheme{Liverpool}

\usepackage{lipsum}
\usepackage{uolbricks}
%\usepackage{tikz}
...
\begin{document}
% Title page can coloured differently using \uolcolours as described below.
%
% to change the image on the right use
%\setbeamertemplate{background}[image right][extra/uol-vg-bw.png]
%\setbeamertemplate{background}[image right][UoL_Logo_Black.eps]
%
...
\begin{frame}%[uolcolours=default]
\maketitle
\end{frame}


% DEMO CONTENT WILL BE RE-USED
