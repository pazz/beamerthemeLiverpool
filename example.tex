...
\maketitle
\end{frame}
% \pgfkeys{/uol/color/style=Teal Green}
% \pgfkeys{/uol/color/style=Skye Blue}
% \pgfkeys{/uol/color/style=Orange}
% \pgfkeys{/uol/color/style=Grey}
% \pgfkeys{/uol/color/style=Pink}
% \pgfkeys{/uol/color/style=Burgundy}
%\pgfkeys{/uol/color/style=Dark Green}
%\pgfkeys{/uol/color/style=Burgundy}

\begin{frame}[t,style={Dark Green}]
